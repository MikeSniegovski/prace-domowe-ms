...
class RecipesDetails extends Component {
  ...
  render() {
    ...
    if (!selectedRecipe) {
      ...
      const { name, ingridients, steps } = selected;
      return (
        <div className="c-recipe">
          ...
          <div className="c-comments">
            <h3 className="c-list__title">Comments</h3>
            <ul className="c-list c-comments__list">
              <li className="c-list__item">
                <div>User name</div>
                <div>2019-02-01</div>
                <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias dicta corrupti at omnis officia pariatur repellat debitis quia facilis obcaecati!</div>
              </li>
              <li className="c-list__item">
                <div>User name</div>
                <div>2019-02-01</div>
