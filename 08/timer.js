...
//prepareDOM (przygotowanie graficznych elementow i wstawienie ich w DOM)
// render (odswiezanie czasu)
// start (startowanie czasu)
// stop (zatrzymanie czasu)
//  reset (reset do 0 sekund)
